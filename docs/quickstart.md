...
1. LAN-only warning.
2. LLM provider. Choose Anthropic, OpenAI, or an OpenAI-compatible endpoint (llama.cpp, Ollama). Enter the API key and select a model. You can switch providers later in Settings.
...
No authentication. Anyone reaching port 8080 reads your data and spends your LLM API balance. Run on a trusted LAN, or follow the [Tailscale guide](deploy-tailscale.md). Full picture in [SECURITY.md](../SECURITY.md).
