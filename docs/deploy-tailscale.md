...
- A Linux VM with Docker or Podman. Hetzner CX22 (€4/mo, 4 GB RAM) is plenty; a Raspberry Pi 5 at home works identically.
...
1. Picks `podman` or falls back to `docker`.
